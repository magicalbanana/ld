...
// New creates a new levenshtein distance calculator where indel is
// increment/deletion cost and sub is the substitution cost.
...
// Dist is a convenience function for a levenshtein distance calculator with
// equal costs.
